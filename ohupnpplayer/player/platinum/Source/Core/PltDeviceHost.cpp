...
// 2025.11.12
// use real subscription timeout as not all apps unsubscribe cleanly
// this shall solve thread leaking and none working after a few days.
#if 0
            // default lease
            ...
            NPT_LOG_FINE_2("PLT_DeviceHost::ProcessHttpSubscriberRequest ProcessRenewSubscription SID=%s timeout=%d",
                           sid ? sid->GetChars() : "nullptr", timeout);
#endif
...
// this shall solve thread leaking and none working after a few days.
            ...
            NPT_LOG_FINE_2("PLT_DeviceHost::ProcessHttpSubscriberRequest ProcessNewSubscription CallbackURLs=%s timeout=%d",
                           callback_urls ? callback_urls->GetChars() : "nullptr", timeout);
#endif
