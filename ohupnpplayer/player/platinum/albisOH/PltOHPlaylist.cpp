...
|   external references
+---------------------------------------------------------------------*/
extern NPT_UInt8 AOH_InfoSCPD[];
extern NPT_UInt8 AOH_PlaylistSCPD[];
extern NPT_UInt8 AOH_ProductSCPD[];
extern NPT_UInt8 AOH_TimeSCPD[];
extern NPT_UInt8 AOH_VolumeSCPD[];
extern NPT_UInt8 AOH_CredentialsSCPD[];
...
PLT_OHPlaylist::PLT_OHPlaylist(const char*  friendly_name,
    ...
    m_Delegate(NULL)
{
    m_ModelDescription = "Schenk Engineering OpenHome Playlist";
...
PLT_OHPlaylist::SetupServices()
{
...

    {
        ...
        NPT_CHECK_FATAL(service->SetSCPDXML((const char*) AOH_ProductSCPD));
        ...
        service->SetStateVariable("ManufacturerName", "Schenk Engineering");
        service->SetStateVariable("ManufacturerInfo", "SNK");
        service->SetStateVariable("ManufacturerUrl", "http://127.0.0.1");
        service->SetStateVariable("ManufacturerImageUri", "http://127.0.0.1");
    ...
    {
        /* see https://opensourceprojects.eu/p/upmpdcli/code/ci/becaa456258ed55ded3fc006a1e148fd4c8024b6/tree/src/ohcredentials.cxx */
        ...
        service = new PLT_Service(
                ...
                "Credentials",
                "urn:schemas-upnp-org:service-1-0");
        NPT_CHECK_FATAL(service->SetSCPDXML((const char*) AOH_CredentialsSCPD));
        NPT_CHECK_FATAL(AddService(service.AsPointer()));

        /* TODO: if needed fill state variable */
...

    {
        ...
        service = new PLT_Service(
            ...
            "Volume",
			"urn:schemas-upnp-org:service-1-0");
        NPT_CHECK_FATAL(service->SetSCPDXML((const char*) AOH_VolumeSCPD));
        NPT_CHECK_FATAL(AddService(service.AsPointer()));
...

    {
        ...
        service = new PLT_Service(
            ...
            "Time",
			"urn:schemas-upnp-org:service-1-0");
        NPT_CHECK_FATAL(service->SetSCPDXML((const char*) AOH_TimeSCPD));
        NPT_CHECK_FATAL(AddService(service.AsPointer()));
...

    {
        ...
        service = new PLT_Service(
            ...
            "Info",
			"urn:schemas-upnp-org:service-1-0");
        NPT_CHECK_FATAL(service->SetSCPDXML((const char*) AOH_InfoSCPD));
        NPT_CHECK_FATAL(AddService(service.AsPointer()));
...

    {
        ...
        service = new PLT_Service(
            ...
            "Playlist",
			"urn:schemas-upnp-org:service-1-0");
        NPT_CHECK_FATAL(service->SetSCPDXML((const char*) AOH_PlaylistSCPD));
        NPT_CHECK_FATAL(AddService(service.AsPointer()));
